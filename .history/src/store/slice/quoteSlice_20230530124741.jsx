...
export const fetchQuotes = createAsyncThunk("fetchQuotes",async(categoryName,{rejectWithValue})=>{
    let response = await fetch(`https://api.api-ninjas.com/v1/quotes?category=${categoryName}`,{
        method:"GET",
        headers:{
